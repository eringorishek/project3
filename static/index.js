...
d3.json("/merged_housing").then(function(response) {
    let geojson = L.choropleth(response[0], {
        valueProperty: 'housing',
        scale: ['black', 'green'],
        steps: 5,
        mode: 'q',
        style: {
        ...
        onEachFeature: function(feature, layer){
            layer.bindPopup('<strong>'+ feature.properties.geoid10 + 
            "</strong><br /><br />Median Income: $" + feature.properties.housing)
        }
    }).addTo(erinMap);
})
